...
{
    NSArray *imageArray = @[@"http://attachments.gfan.com/forum/attachments2/201410/03/105713svbpmefhe1fovm4p.jpg"];
    NSString *imageUrl = imageArray[0];
    
    NSString  *imgLinkUrl = @"http://www.jianshu.com/users/e4c63b354a77/latest_articles";
    
    NSString  *imgDeadline =  @"09/30/2020 14:25";
